...
def ahorcado():
    ...
    while True:
        ...
        if letra in palabraList:
            ...
            palabraList = [i for i in palabraList if i!=letra]
            print("Muy bien")
        else:
            vidas += -1
            print("Has fallado")
        print(muñeco[5-vidas])
        if vidas > 0:
            print(" ".join(relleno))
            if faltan < 1:
                return print("Has ganado")
        else:
            return print("Has muerto")
